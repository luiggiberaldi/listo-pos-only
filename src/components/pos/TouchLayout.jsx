...
// Archivo: src/components/pos/TouchLayout.jsx
// Antes: 30+ props passthrough. Ahora: se conecta directamente a stores.
...
export default function TouchLayout({
    ...
    if (!cajaAbierta) {
        return <WelcomeScreen onAbrir={abrirCaja} />;
    }
            ...
            {ventaExitosa && (
                <div className="fixed inset-0 z-[100] bg-surface-dark/90 backdrop-blur-sm flex flex-col items-center justify-center animate-in fade-in duration-300">
                    <div className="relative flex flex-col items-center">
                        <img src="logo_success.png?v=2" alt="LISTO POS" className="h-48 w-auto relative z-10 drop-shadow-2xl object-contain" />
                    ...
                    <div className="flex gap-4 mb-4">
                        <div className="flex-1 relative">
                            ...
                            <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-1 opacity-40">
                                ...
                                <span className="text-xs font-mono font-bold">{tasa.toFixed(2)}</span>
                            </div>
                        </div>
                        <button
                            onClick={toggleAyuda}
                        ...
                        <button
                            onClick={() => useUIStore.getState().openModal('ESPERA')}
